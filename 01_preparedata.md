...
## (Kaggle からデータをダウンロードする手順をスキップしたい場合)

"機械学習" の操作フローを理解することに集中したい場合は、Kaggle からデータセットをダウンロードする代わりに、[titanic_train.csv](./dataset/titanic_train.csv) および [titanic_test.csv](./dataset/titanic_test.csv) をダウンロードしてください。  

Kaggle からデータセットをダウンロードする手順をスキップして、次のステップの [**データの分析**](./02_dataanalyze.md) にすぐに進むことができます。
